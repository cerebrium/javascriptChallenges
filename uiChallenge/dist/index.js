...
let letterArray = ['F', 'A', 'C', 'I', 'O', 'B', 'Q', 'P', 'A', 'N', 'O', 'B', 'M', 'A', 'S', 'S'];
const visitedArray = [];
// make a hashtable of the array of letters
const hashMaker = (array) => {
...
const checkHash = hashMaker(letterArray);
// hash to used as visited
const visitedHash = {};
// function for finding closest relative
const closestRelative = (index, indexArray) => {
    /*
...
const updateValue = (e) => {
    ...
    if (target) {
        ...
        let inputLetters = target.value.split("");
                ...
                if (inputLetters.length === 1) {
                    ...
                    if (checkHash[letter].length > 1) {
                        ...
                        */
                        ...
                        console.log("visited hash: ", visitedHash);
